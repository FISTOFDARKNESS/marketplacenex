export const ALERTS_LOCALES = {
  en: {
    ...
    notSupported: 'This browser does not support push notifications.', maxReached: 'You can track at most 25 items.',
  ...
  pt: {
    ...
    notSupported: 'Este navegador nao suporta notificacoes push.', maxReached: 'Voce pode rastrear no maximo 25 itens.',
  ...
  it: {
    ...
    notSupported: 'Questo browser non supporta le notifiche push.', maxReached: 'Puoi monitorare al massimo 25 oggetti.',
  ...
  es: {
    ...
    notSupported: 'Este navegador no admite notificaciones push.', maxReached: 'Puedes seguir maximo 25 articulos.',
  ...
  fr: {
    ...
    notSupported: 'Ce navigateur ne prend pas en charge les notifications push.', maxReached: 'Vous pouvez suivre 25 articles max.',
  ...
  de: {
    ...
    notSupported: 'Dieser Browser unterstutzt keine Push-Benachrichtigungen.', maxReached: 'Du kannst maximal 25 Items verfolgen.',
